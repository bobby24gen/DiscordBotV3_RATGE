...
public class InteractionHandler
{
    ...
    public InteractionHandler(DiscordSocketClient client, InteractionService handler, IServiceProvider services, IConfiguration config, IAudioService audioService)
    {
        _client = client;
        _handler = handler;
        _services = services;
